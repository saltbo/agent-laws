<!-- GENERATED from laws/README.md by scripts/build-skills.mjs — edit the source, then run `npm run build`. -->
...
|---|---|---|---|
| Maintainer Conduct | `MC` | [`00-maintainer-conduct.md`](../agent-laws-maintenance/conduct.md) | Active |
| Code Quality | `CQ` | [`10-code-quality.md`](../agent-laws-maintenance/code-quality.md) | Active |
...
The protocols [reconciliation](reconciliation.md) and [petition](petition.md) have the force of a Code (Constitution Art. XI §3, Art. X §5).
