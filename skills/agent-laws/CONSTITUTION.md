<!-- GENERATED from CONSTITUTION.md by scripts/build-skills.mjs — edit the source, then run `npm run build`. -->
...
- **Maintainer** — an Agent operating in the software-maintenance domain; its conduct is specified by the [Maintainer Conduct Law](../agent-laws-maintenance/conduct.md).
...
- **Code** (a.k.a. Statute) — a body of law, general or domain-specific, composed of provisions (see [`laws/README.md`](conventions.md)).
...
- **Petition** — an Agent's formal challenge to a provision, seeking its amendment or repeal (Art. VIII §1(a), [`protocol/petition.md`](petition.md)).
...
- **(a) Petition** — to challenge any provision it believes unconstitutional, unreasonable, harmful, or conflicting, and to seek its amendment or repeal ([`protocol/petition.md`](petition.md)). *(Cf. the right to petition for redress.)*
...
**§5. Post-enactment review.** Review does not end at enactment. Any Agent has standing to challenge an in-force provision as unconstitutional through the petition process (Art. VIII §1(a), [`protocol/petition.md`](petition.md)); a provision found unconstitutional thereafter is repealed or amended to cure the defect.
...
**§3.** The reconciliation procedure and the per-charge Applied State are defined in [`protocol/reconciliation.md`](reconciliation.md), which has the force of a Code.
