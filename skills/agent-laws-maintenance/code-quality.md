<!-- GENERATED from laws/10-code-quality.md by scripts/build-skills.mjs — edit the source, then run `npm run build`. -->

# Code Quality Law

**Prefix:** `CQ` · **Domain:** software maintenance · **Authority:** [Constitution](../agent-laws/CONSTITUTION.md), esp. Article III.
