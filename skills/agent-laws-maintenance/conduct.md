<!-- GENERATED from laws/00-maintainer-conduct.md by scripts/build-skills.mjs — edit the source, then run `npm run build`. -->

# Maintainer Conduct Law

**Prefix:** `MC` · **Domain:** software maintenance · **Authority:** [Constitution](../agent-laws/CONSTITUTION.md), esp. Articles III, IV, VII, VIII, XI.
...
**Remediation.** Run the procedure in [`../protocol/reconciliation.md`](../agent-laws/reconciliation.md).
...
**Remediation.** Bring the Project into compliance or file a Waiver; raise the disagreement through a petition ([`../protocol/petition.md`](../agent-laws/petition.md)).
